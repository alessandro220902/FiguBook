    ...
    <div className="grid min-h-screen place-items-center bg-[#080a08] px-6 text-[#f4efe6]">
      <div className="w-full max-w-[440px] rounded-3xl border border-white/10 bg-[#0c100c]/70 p-8 text-center shadow-2xl backdrop-blur-xl">
        ...
        <button
          ...
          onClick={check}
          disabled={checking}
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-lime py-3.5 font-semibold text-lime-ink transition-[filter] hover:brightness-110 disabled:opacity-50"
        >
