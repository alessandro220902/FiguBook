...
export function AppLayout() {
  ...
  return (
    <div
      ...
      style={{
        background: isAlbum
          ? 'radial-gradient(120% 90% at 50% -8%, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.015) 38%, transparent 64%), radial-gradient(rgba(255,255,255,0.022) 1px, transparent 1px) 0 0 / 22px 22px, #121212'
