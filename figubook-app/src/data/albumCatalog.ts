...
import calciatori2425Cover from '@/assets/covers/calciatori-24-25.png'
import calciatori2223Cover from '@/assets/covers/calciatori-22-23.png'
import mondiali2026Cover from '@/assets/covers/mondiali-2026.png'
import matchAttaxUclCover from '@/assets/covers/match-attax-ucl.png'
...
export const ALBUM_CATALOG: AlbumCatalogEntry[] = [
  ...
  { id: 'calciatori-24-25', title: 'Calciatori 2024/25', editor: 'Panini', season: '2024/25', total: 886, href: 'figubook-calciatori-2425.html', missingParam: '2425', storageKey: 'figubook-calciatori-2425-v1', tags: ['panini', '2425'], c1: '#f2c200', c2: '#1a1a1a', cover: calciatori2425Cover },
  ...
  { id: 'calciatori-22-23', title: 'Calciatori 2022/23', editor: 'Panini', season: '2022/23', total: 739, href: 'figubook-calciatori-2223.html', missingParam: '2223', storageKey: 'figubook-calciatori-2223-v1', tags: ['panini'], c1: '#2e8b57', c2: '#d4451f', cover: calciatori2223Cover },
  { id: 'mondiali-2026', title: 'FIFA World Cup 2026', editor: 'Panini', season: '2026', total: 992, href: 'figubook-fwc2026.html', missingParam: 'fwc2026', storageKey: 'figubook-fwc2026-v1', tags: ['panini', '2526'], c1: '#d4451f', c2: '#1b6fb8', addedAt: '2026-07-10', cover: mondiali2026Cover },
  ...
  { id: 'match-attax-ucl', title: 'Match Attax UCL 25/26', editor: 'Topps', season: '2025/26', total: 584, href: 'figubook-matchattax-2526.html', missingParam: 'matchattax2526', storageKey: 'figubook-matchattax-ucl-2526-v1', tags: ['topps', '2526'], c1: '#2a1b6c', c2: '#c0297a', cover: matchAttaxUclCover },
]
